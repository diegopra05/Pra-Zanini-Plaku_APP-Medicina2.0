...
public class RegisterApiController {
    ...
    public ResponseEntity registerNewUser(@Param("nome") String nome,
        ...
        int result = userService.registerNewUserServiceMethod(nome, cognome, email, hashed_password); //ritorna 1 se è stato inserito se no 0

        if(result != 1){   // non è stato inserito correttamente
